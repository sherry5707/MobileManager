...
public class ViewPagerTabStrip extends LinearLayout {
    ...
    // RGKMyUI
    private int mSelectedUnderLinePadding;
    // RGKMyUI End
    ...
    public ViewPagerTabStrip(Context context, AttributeSet attrs) {
        ...
        // RGKMyUI
        mSelectedUnderLinePadding =
                res.getDimensionPixelOffset(R.dimen.rgk_view_pager_tab_underline_padding);
        // RGKMyUI End
        mSelectedUnderlineThickness =
                res.getDimensionPixelSize(R.dimen.tab_selected_underline_height);
        int underlineColor = res.getColor(R.color.tick_yellow);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (childCount > 0) {
            ...
            // RGKMyUI
            selectedLeft = selectedLeft + mSelectedUnderLinePadding;
            selectedRight = selectedRight - mSelectedUnderLinePadding;
            // RGKMyUI End
